...
if __name__ == "__main__":
    ...
    parser.add_argument('--resolution', default=0.08, type=float)
    ...
    model = scMultiCluster(input_dim1=input_size1, input_dim2=input_size2, device=args.device).to(args.device)
    print(str(model))
